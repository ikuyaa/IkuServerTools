...
import com.ikuyadev.ikuservertools.managers.EventManager;
...
public class IkuServerTools {
    ...
    public IkuServerTools(IEventBus modEventBus, ModContainer modContainer) {
        // Register the config
        modContainer.registerConfig(ModConfig.Type.SERVER, Config.SPEC);
        LOGGER.info("IkuServerTools: Config registered.");
